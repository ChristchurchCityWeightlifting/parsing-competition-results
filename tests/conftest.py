...
def mock_data(mock_athlete, mock_competition, mock_lift):
    ...
    logging.debug("[italic]=== Verifying Token ===[/italic]", extra={"markup": True})
    ...
    def obtain_access_token():
        ...
        logging.debug("[green]...Token verfied[/green]", extra={"markup": True})
        return access_token

    # set up
    log.info("[itallics]===Mock Data Set Up===[/itallics]", extra={"markup": True})
    ...
    log.info("[green]...Set Up completed.[/green]", extra={"markup": True})
    _mocked_data = {
    ...
    # TODO: could be async?
    log.info(
        "[itallics]===Mock Data Tear Down Started===[/itallics]", extra={"markup": True}
    )
    ...
    log.info("[green]...Tear down complete.[/green]", extra={"markup": True})
